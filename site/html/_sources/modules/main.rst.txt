...
Основной файл запуска бота, который инициализирует все компоненты и запускает телеграм-бота. Этот файл является точкой входа для запуска бота учета персонала для кофеен.
